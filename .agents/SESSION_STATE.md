...
_Last sync: 2026-04-20 17:20:36 (trigger: hook:Stop)_
...
- [project_rolling_dashboard_2026_04_19.md](project_rolling_dashboard_2026_04_19.md) — **Rolling dashboard plan (2026-04-19)**: Unified view — past week + past month summaries, rolling 7d past + 7d forward (events/tasks). Aggregation layer over existing WKY, MTH, DLY, calendar sources. Plan-only; no build yet.
