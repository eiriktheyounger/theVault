...
_Last sync: 2026-03-31 12:32:52 (trigger: hook:Stop)_
...
- [project_email_ingester.md](project_email_ingester.md) — Email Thread Ingester (2026-03-30): Exchange+Gmail, thread grouping, job tracker, daily backlinks. Build prompt at .agents/email_ingester_build_prompt.md
- [project_applescript_bridge_test.md](project_applescript_bridge_test.md) — AppleScript Mail.app extraction test (2026-03-31): Gmail ✅ 4/4, Exchange ⚠️ timeout @ 240s on 2,327 messages. Recommendations for fix.
