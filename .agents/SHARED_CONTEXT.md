...
- **2026-04-03**: clean_md_processor.py `--reprocess` flag added — reads from Processed/Plaud/ instead of Inbox, sets force=True to overwrite -Full.md output, skips moving source files. Allows re-summarization without manually moving originals back to inbox.
